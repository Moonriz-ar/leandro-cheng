...
const MainNav = ({ handleClick }) => {
  return (
    <nav className="flex justify-between w-screen px-4 py-3 text-sm font-extrabold text-gray-800 bg-gray-50 drop-shadow">
      <div className="">
        <Link href="/">
        ...
        <ul className="flex">
          ...
          <li>
            <Link href="/guide-service">
              <a className="px-2 py-1 ml-3 text-gray-800 transition duration-150 ease-in border border-gray-400 rounded hover:text-gray-700">
                攝影嚮導
              </a>
            </Link>
          </li>
